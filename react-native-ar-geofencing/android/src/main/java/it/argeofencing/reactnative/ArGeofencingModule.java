...
package it.argeofencing.reactnative;
...
public class ArGeofencingModule extends ReactContextBaseJavaModule {
  ...
  public ArGeofencingModule(ReactApplicationContext reactContext) {
    super(reactContext);
